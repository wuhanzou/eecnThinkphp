...
-----------------------------
-- TP自带的权限认证数据库表   ThinkPHP/Libraty/Think/Auth.class.php
  /*
-- ----------------------------
-- think_auth_rule，规则表，
...
-- -----------------------------
-- Table structure for `eecn_auth_rule`
-- -----------------------------
DROP TABLE IF EXISTS `eecn_auth_rule`;
CREATE TABLE `eecn_auth_rule` (
...
) ENGINE=MyISAM AUTO_INCREMENT=217 DEFAULT CHARSET=utf8 COMMENT='权限认证规则表';

-- -----------------------------
-- Table structure for `eecn_auth_group`
-- -----------------------------
DROP TABLE IF EXISTS `eecn_auth_group`;
CREATE TABLE `eecn_auth_group` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='权限认证用户组表';

-- -----------------------------
-- Table structure for `eecn_auth_group_access`
-- -----------------------------
DROP TABLE IF EXISTS `eecn_auth_group_access`;
CREATE TABLE `eecn_auth_group_access` (
  `uid` int(10) unsigned NOT NULL COMMENT '用户id',
  `group_id` mediumint(8) unsigned NOT NULL COMMENT '用户组id',
  UNIQUE KEY `uid_group_id` (`uid`,`group_id`),
  KEY `uid` (`uid`),
  KEY `group_id` (`group_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='权限认证用户组明细表';